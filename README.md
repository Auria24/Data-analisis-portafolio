...
- [Portafolio de proyectos]()
  ...
  utilizando extración de datos y generacion de tablas con SQL
    ...
    - [Tableau](https://github.com/Auria24/data-analisis-portafolio/tree/main/tableau)
      ...
      Al analizar las diferentes categorias de videos mas populares se encontraron 5 en tendecia en lo diferentes paises que fueron: Estados unidos, India, Francia y Rusia. en estados unidos existe el mayor consumo.
    ...
    Se realiza un Análisis de call center, para determinar el tiempo de llamanadas en espera y porsentage de llamadas perdidas por los difernetes ajentes telefonicos. se realiza una pryeva de hipótesis  para comparar si las llamadas perdidas y las de espera cuantan con un porcentaje inadecuado con las llamadas respondidas.
    ...
    Se realiza un aná0lisis  de ventas haciendo un comparativo de las sucursales las cuales se encuentran ubicadas en diferentes regiones, y buscando cuales son los productos mas y menos vendidos deacuerdo a ello, se determinara cual es la mas y menos rentable.
    ...
    - [Dasboard de call center en power bi](https://app.powerbi.com/view?r=eyJrIjoiNjM2MmEzYzItMTVmNC00NjFiLTkzNzgtNjNkZWNmMzM2N2E2IiwidCI6IjBhNWNiMWFkLTE4MDMtNDlhMi1hNzg5LWQxMzZkYjAxMTVjYiJ9)
      ...
      Se precenta de manera grafica el desempeño de un call center, deacurdo al tipo de llamada, y se investiga cual es la razon de las llamadas no resueltas y la eficiencia de cada uno de los ajentes encargados.
